			...
			<div className="container-fluid fl-home bg-banner">
				<div className="row banner-center">
					<div className="fl-homebanner-text text-center">
						...
						<p>
							Whether your aim is to loose weight, tone up, gain weight we can put together a gym programme or recommend the right classes for you to
							attend in our studios.
						</p>
					</div>
				</div>
			</div>
